...
public class JwtAuthenticationByPhoneFilter extends UsernamePasswordAuthenticationFilter {  // (1)
    private final AuthenticationManager authenticationManager;
    private final JwtTokenizer jwtTokenizer;
    private final TokenService tokenService;

    public JwtAuthenticationByPhoneFilter(AuthenticationManager authenticationManager,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
        ...
        LoginByPhoneDto loginByPhoneDto = objectMapper.readValue(request.getInputStream(), LoginByPhoneDto.class);
...
//
//        LoginDto loginByPhoneDto = new LoginDto();
//        try {
//            loginByPhoneDto.setEmail(results[3]);
//            loginByPhoneDto.setPassword(results[7]);
//        } catch (Exception e) {
////            double num = Math.random();
//            loginByPhoneDto.setEmail("test@gamil.com");
//            loginByPhoneDto.setPassword("q1q1Q!Q!");
//            User user = new User();
//            user.setEmail(loginByPhoneDto.getEmail());
//            user.setPassword(loginByPhoneDto.getPassword());
//            user.setName("test");
//            userService.createUser(user);
//        }
//        System.out.println("!! email : " + loginByPhoneDto.getEmail());
//        System.out.println("!! pw : " + loginByPhoneDto.getPassword());


        UsernamePasswordAuthenticationToken authenticationToken =
                new UsernamePasswordAuthenticationToken(loginByPhoneDto.getLoginId(), loginByPhoneDto.getPhone());
